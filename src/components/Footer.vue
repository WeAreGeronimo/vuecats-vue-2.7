  ...
  methods: {
    subscribeToNews() {
      if(this.validateEmail(this.email)) {
        ...
        document.getElementById('tips').innerText = 'Введите, пожалуйста, действительный Email!';
...
.footer {
  ...
  &-buy {
    color: #ffffff;
    width: 25.063rem;
    margin: 5.188rem 0 5.75rem 4rem;
  }

  &-emailsWrapper {
    position: relative;
    margin: 5.688rem 1rem 0 0;
  }
  ...
  &-check {
    ...
    & + label:before {
      ...
      align-items: center;
      margin: 0.125rem 0.375rem 0.125rem 0.125rem;
      background: #f5f5f5;
